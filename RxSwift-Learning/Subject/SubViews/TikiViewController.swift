...
class TikiViewController: UIViewController {
    ...
    // MARK: - init
    init(viewModel: TikiTakaProtocol = TikiViewModel()) {
        self.viewModel = viewModel
        super.init(nibName: nil, bundle: nil)
    }
    
    required init?(coder: NSCoder) {
        self.viewModel = TikiViewModel()
